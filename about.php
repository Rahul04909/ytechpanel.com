            ...
            <div class="ab-mv-grid">
                <div class="ab-mv-card">
                    <div class="ab-mv-icon">
                        <svg viewBox="0 0 24 24" width="32" height="32" fill="none" stroke="#dc2626" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="ab-wcu-grid">
                <div class="ab-wcu-item">
                    <div class="ab-wcu-icon">
                        <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="#dc2626" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
